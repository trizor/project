...
<div class="container">
		...
		<h2 class="text-center top-space">Отчет о стоимости аренды за период</h2>
		<br>
		...
		<div class="col-md-4 col-md-offset-4">
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<form class="form-horizontal" role="form" method="POST" action="/admin/rent_period/">
...
<div class="form-horizontal">
  ...
  <div class="form-group" align="center">
                    ...
                    <br/>
                            ...
                            <br/>
                            Стоимость за период {{$contract -> cost}} грн.
                            <br/>
                             <br/>
                            </div>
                            <div class="col-md-2">
